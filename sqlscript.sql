...
ALTER TABLE [dbo].[AssignedJobs]  WITH CHECK ADD FOREIGN KEY([EmpId])
REFERENCES [dbo].[Employees] ([Id])
GO

ALTER TABLE [dbo].[AssignedJobs]  WITH CHECK ADD FOREIGN KEY([JobId])
...
ALTER TABLE [dbo].[Chat]  WITH CHECK ADD FOREIGN KEY([RecieverId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO
...
ALTER TABLE [dbo].[Payments]  WITH CHECK ADD FOREIGN KEY([AssignmentId])
REFERENCES [dbo].[AssignedJobs] ([Id])
GO
CREATE TABLE [dbo].[QualificationsOfEmployees](
	[Id] [int] IDENTITY(1,1) NOT NULL,
...
ALTER TABLE [dbo].[QualificationsOfEmployees]  WITH CHECK ADD FOREIGN KEY([EmpId])
REFERENCES [dbo].[AspNetUsers] ([Id])
GO
